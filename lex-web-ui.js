...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-layout',{staticClass:"message-list ma-0 pt-1",attrs:{"column":""}},_vm._l((_vm.messages),function(message){return _c('message',{key:message.id,class:("message-" + (message.type)),attrs:{"message":message}})}))}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-layout',{staticClass:"input-container",attrs:{"row":"","child-flex":"","justify-space-between":""}},[_c('v-toolbar',{staticClass:"white"},[_c('v-text-field',{directives:[{name:"show",rawName:"v-show",value:(_vm.shouldShowTextInput),expression:"shouldShowTextInput"}],attrs:{"label":_vm.textInputPlaceholder,"id":"text-input","name":"text-input","single-line":"","hide-details":""},on:{"keyup":function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"enter",13)){ return null; }$event.stopPropagation();_vm.postTextMessage($event)},"focus":_vm.onTextFieldFocus,"blur":_vm.onTextFieldBlur},model:{value:(_vm.textInput),callback:function ($$v) {_vm.textInput=$$v},expression:"textInput"}}),_vm._v(" "),_c('recorder-status',{directives:[{name:"show",rawName:"v-show",value:(!_vm.shouldShowTextInput),expression:"!shouldShowTextInput"}]}),_vm._v(" "),(_vm.shouldShowSendButton)?_c('v-btn',{directives:[{name:"tooltip",rawName:"v-tooltip:left",value:({html: 'send'}),expression:"{html: 'send'}",arg:"left"}],staticClass:"black--text mic-button",attrs:{"disabled":_vm.isSendButtonDisabled,"icon":""},on:{"click":_vm.postTextMessage}},[_c('v-icon',{attrs:{"medium":""}},[_vm._v("send")])],1):_c('v-btn',{directives:[{name:"tooltip",rawName:"v-tooltip:left",value:({html: _vm.micButtonTooltip}),expression:"{html: micButtonTooltip}",arg:"left"}],staticClass:"black--text mic-button",attrs:{"disabled":_vm.isMicButtonDisabled,"icon":""},on:{"click":_vm.onMicClick}},[_c('v-icon',{attrs:{"medium":""}},[_vm._v(_vm._s(_vm.micButtonIcon))])],1)],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
module.exports = {"cognito":{"poolId":"us-east-1:8ac68463-d94c-4c7d-84c4-5cebee7bf95c"},"lex":{"botName":"DslSupport","initialText":"You can get help for your DSL related problems. Just type \"I have an internet problem\" or click on the mic and say it.","initialSpeechInstruction":"Say 'Internet Problem' to get started."},"polly":{"voiceId":"Salli"},"ui":{"parentOrigin":"","pageTitle":"DSL Support Bot","toolbarTitle":"DSL Support"},"recorder":{"preset":"speech_recognition"}}
